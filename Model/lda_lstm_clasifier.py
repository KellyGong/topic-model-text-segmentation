...
class LDA_LSTM_Classifier(nn.Module):
    def __init__(self, args, topic_size, lda_size, GRU=False, input_dim=768, hidden_dim=128, output_dim=2, n_layers=2,
                 bidirectional=True,
                 dropout=0.5):
        ...
        self.lda = ProdLDA(args, lda_size)
    ...
    def forward(self, sentences_embedding_papers, seg_label, enforced_teach=False):
